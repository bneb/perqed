...
#align(center)[
  #text(weight: "bold", size: 12pt, fill: blue.darken(20%))[R(5,5) < 43]
]
...
```json
Best Graph Energy Threshold Hit: 0
```
#line(length: 100%, stroke: 0.5pt)
...
- *SDP Lower Bound:* `42.00000`
- *SDP Upper Bound:* `43.10000`
...
*Z3/Lean Verification Status:* `PROVED`
